...
namespace CRUDAppUsingAspCoreWebApi.Controllers
{
    ...
    {
        private string url = "https://localhost:7290/api/EmployeeApi/";
        ...
        public IActionResult Edit(Employee emp)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                TempData["Update message"] = " Employee updated successfully.";
                return RedirectToAction("Index");
            }
            return View();
        }
        ...
        public IActionResult DeleteConfirmed(int id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                TempData["Delete message"] = " Employee delete successfully.";
                return RedirectToAction("Index");
            }
            return View();
        }
